	...
	methods: {
		...
		googleregister: async function () {
			...
			if (this.username == "" || this.password == "" || this.phone == "") {
				...
				var headers = { Authorization: "Bearer " + this.accesstoken };
				await axios
					.post(baseurl + "/user/auth/google-complete-register.php", form_data, { headers })
					.then(function (response) {
		...
		updatePassword: async function () {
			...
			if (this.password == "" || this.confirm_password == "" || this.old_password == "") {
				...
				await axios
					.post(baseurl + "user/profile/change_password.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
							$(".btn").html("Change password");
		...
		updateUsername: async function () {
			...
			if (this.username == "") {
				...
				await axios
					.post(baseurl + "user/profile/update_username.php", form_data, { headers })
					.then(function (response) {
						$(".change_username").text("Update Username");
						if (response.data.status == true) {
		...
		updateProfile: async function () {
			...
			if (this.firstname == "") {
				...
				await axios
					.post(baseurl + "user/profile/update_profile.php", form_data, { headers })
					.then(function (response) {
						$(".btn-3").text("Submit");
						if (response.data.status == true) {
							$(".btn-3").html("Submit");
		...
		updateBasicDetails: async function () {
			...
			if (this.country.length == 0) {
				...
				await axios
					.post(baseurl + "user/profile/update_basic_profile.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
		...
		updatePin: async function () {
			...
			if (first.length != 4 || second.length != 4) {
				...
				await axios
					.post(baseurl + "user/profile/change_pin.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
							toastr.success(response.data.text, "Success");
							self.getUserDetails();
		...
		updateNextOfKin: async function () {
			...
			if (this.next_of_kin_name == "") {
				...
				await axios
					.post(baseurl + "user/profile/update_next_of_kin.php", form_data, { headers })
					.then(function (response) {
						$(".btn-3").text("Submit");
						if (response.data.status == true) {
							$(".btn-3").html("Submit");
		...
		updateCommunication: async function () {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/profile/update_communication.php", form_data, { headers })
				.then(function (response) {
					if (response.data.status == true) {
						this.success = response.data.text;
						new toastr.success(response.data.text, "Success", { duration: 1000 });
		...
		verifyBank: async function () {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/systems/verifyBanks.php", form_data, { headers })
				.then(function (response) {
					if (!response.data.status) {
						Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
							////this.logout();
		...
		addUserBanks: async function () {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/systems/addUserBanks.php", form_data, { headers })
				.then(function (response) {
					self.stopLoading();
					if (!response.data.status) {
						Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
		...
		sendverifyotp: async function (id) {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/otp/send_otp_verification_for_2fa_in.php", form_data, { headers })
				.then(function (response) {
					$(".verify-password-mod button").css("background-color", "black");
					if (response.data.status == true) {
						this.success = response.data.text;
		...
		verify: async function (id, type) {
			...
			if (code.length != 7) {
				...
				await axios
					.post(baseurl + "user/otp/verify_otp_to_set_2fa.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
							new toastr.success(response.data.text, "Success");
							self.getUserDetails();
		...
		set_google_auth_app: async function () {
			...
			if (code.length != 6) {
				...
				await axios
					.post(baseurl + "user/otp/verify_otp_to_set_2fa_with_google.php", form_data, { headers })
					.then(function (response) {
		...
		update_login_app: async function () {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/otp/update-login-key.php", form_data, { headers })
				.then(function (response) {
					if (response.data.status == true) {
						this.success = response.data.text;
						new toastr.success(response.data.text, "Success");
		...
		verify_inner: async function (id, type) {
			...
			await axios
				.post(baseurl + "user/otp/verify_phone.php", form_data, { headers })
				.then(function (response) {
					if (response.data.status == true) {
		...
		remove2fa: async function (id) {
			...
			if (code.length != 7) {
				...
				await axios
					.post(baseurl + "user/otp/verify_otp_to_remove_2fa.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
		...
		removegoogle2fa: async function (id) {
			...
			if (code.length != 6) {
				...
				await axios
					.post(baseurl + "user/otp/verify_otp_to_remove_google_2fa.php", form_data, { headers })
					.then(function (response) {
						if (response.data.status == true) {
							$(".verification-removal_trigger").html("Submit").removeClass("disabled");
							this.success = response.data.text;
				...
				if (this.username == this.withdrawal_username || this.email == this.withdrawal_username) {
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							...
							axios
								.post(baseurl + "user/transaction/addTransaction.php", form_data, { headers })
								.then(function (response) {
									self.stopLoading();
									if (!response.data.status) {
										Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
				...
				if (this.username == this.withdrawal_username || this.email == this.withdrawal_username) {
					...
					Swal.fire({
						...
						if (result.isConfirmed) {
							...
							var headers = { Authorization: "Bearer " + self.accesstoken };
							axios
								.post(baseurl + "user/transaction/sendswapcrypto.php", form_data, { headers })
								.then(function (response) {
									self.stopLoading();
									if (!response.data.status) {
										Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
		...
		generateCoinAddress: async function () {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			await axios
				.post(baseurl + "user/transaction/generatecryptoAddress.php", form_data, { headers })
				.then(function (response) {
					if (!response.data.status) {
		...
		initiateTransaction: async function () {
			...
			if (parseInt(this.recieve_amount) > parseInt(this.deposit_min)) {
				if (this.recieve_amount == "") {
					...
					var headers = { Authorization: "Bearer " + this.accesstoken };
					await axios
						.post(baseurl + "user/transaction/initiateDeposit.php", form_data, { headers })
						.then(function (response) {
							self.stopLoading();
							if (!response.data.status) {
								Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
		...
		verifyPayments: async function () {
			...
			if (getAllUrlParams().trxref) {
				...
				var headers = { Authorization: "Bearer " + this.accesstoken };
				await axios
					.post(baseurl + "user/transaction/verifyPayments.php", form_data, { headers })
					.then(function (response) {
						self.stopLoading();
						if (!response.data.status) {
		...
		getSingleTrans: async function (transid) {
			...
			var headers = { Authorization: "Bearer " + self.accesstoken };
			axios
				.post(baseurl + "user/transaction/gettransdetails.php", form_data, { headers })
				.then(function (response) {
					self.stopLoading();
					if (!response.data.status) {
						Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
		...
		verifyPinPeerstack() {
			...
			var headers = { Authorization: "Bearer " + this.accesstoken };
			axios
				.post(baseurl + "user/auth/verifypin.php", form_data, { headers })
				.then(function (response) {
					self.stopLoading();
					if (!response.data.status) {
						Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
		...
		getcompletebvn(load = 1) {
			...
			axios
				.post(baseurl + "user/kyc/get_bvn.php", form_data, { headers })
				.then(function (response) {
		...
		verifyKYC: async function () {
			...
			if (this.bvn == "") {
				...
				await axios
					.post(baseurl + "user/kyc/verify_bvn.php", form_data, { headers })
					.then(function (response) {
						...
						if (response.data.status == true) {
							...
							if (
								...
								typeof response.data.data[0].phoneno !== "undefined"
							) {
		...
		sendExternalAddress: async function () {
			...
			if ($(".pin11").val() != undefined) {
				...
				user2fapin =
					$(".pin5").val() + "" + $(".pin6").val() + "" + $(".pin7").val() + "" + $(".pin8").val() + "" + $(".pin9").val() + "" + $(".pin10").val();
			}
			...
			} else if (parseInt(this.subwalletusdamt) >= parseInt(this.withdrawal_amount)) {
				if (this.username == this.withdrawal_username || this.email == this.withdrawal_username) {
					self.stopLoading();
					self.error = "Cannot Intiate withdrawal, Username Cannot be the same as sender's";
		...
		validateAddress: async function () {
			...
			var headers = { Authorization: "Bearer " + self.accesstoken };
			axios
				.post(baseurl + "user/wallet/validate_useraddress.php", form_data, { headers })
				.then(function (response) {
					self.stopLoading();
					if (!response.data.status) {
						// 	Swal.fire("Opps, an error occured, try again later", response.data.text,"warning").then(function(){
		...
		getCoinFeeWithNetwork: async function (clicked = 0) {
			...
			if (this.withdrawal_amount == "" || this.withdrawal_amount == 0 || isNaN(this.withdrawal_amount)) {
				...
				if (this.externaladdress == "" || this.externaladdress == 0) {
					...
					var headers = { Authorization: "Bearer " + self.accesstoken };
					axios
						.post(baseurl + "user/wallet/get_network_address_withfee.php", form_data, { headers })
						.then(function (response) {
							self.stopLoading();
							if (!response.data.status) {
								self.loading = false;
		...
		async proceedToSwapAddress() {
			...
			popmsg =
				...
				this.amounttosell +
				" " +
				this.active_swapcurrencies.name +
				" to " +
				convertto +
				" " +
				this.active_swaptocurrencies.coin_to_name;
			Swal.fire({
				title: "Are you sure?",
				text: popmsg,
				icon: "warning",
		...
		deleteUserAccount: async function () {
			...
			Swal.fire({
				...
				if (result.isConfirmed) {
					...
					var headers = { Authorization: "Bearer " + self.accesstoken };
					axios
						.post(baseurl + "user/auth/delete_account.php", {}, { headers })
						.then(function (response) {
							self.stopLoading();
							if (!response.data.status) {
								Swal.fire("Opps, an error occured, try again later", response.data.text, "warning").then(function () {
