            ...
            if($numRow > 0){  
                ...
                if($numRow > 0){
                    while($users = $result->fetch_assoc()){
                      ...
                      array_push( $allResponse,array("cointrackid"=>$ngnsubwallet,"livevalue"=>$coinrate,"img"=>"https://app.cardify.co/assets/images/nigeria.png","coinrate"=>$coinrate,"name"=>"NGN","shortname"=>"NGN","usdbalance"=>round($thusdval,2),"balance"=>$walletbal,"trackid"=>$trackid,"crypto"=>0));
                    }
                }
            }
                ...
                while($users1 = $result1->fetch_assoc()){
                    ...
                    if($numRow > 0){
                        ...
                        while($users = $result->fetch_assoc()){
                            ...
                            $walletbal=" $walletbal";
                            array_push( $allResponse,array("cointrackid"=>$subwallettag,"crypto"=>1,"livevalue"=>round($getlivevalu),"img"=>$imglink,"coinrate"=>$coinrate,"name"=>$coinname,"shortname"=>$shortname,"usdbalance"=>$thusdval,"balance"=>$walletbal,"trackid"=>$trackid));
                        }
