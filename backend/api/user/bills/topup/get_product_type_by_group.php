...
if ($method == 'POST') {
    ...
    $user_pubkey = cleanme($decodedToken->usertoken);
        ...
        if ( !isset($_POST['country_tid'])||!isset($_POST['category_tid'])||!isset($_POST['groupname']) ) {
            ...
            $groupname= cleanme($_POST['groupname']);
        }
        ...
        $bindparamss.="s";
        // main catgeory
        $queryClause .= " AND maincat_tid=? ";
        $bindparams[]=$category_tid;
        $bindparamss.="s";
                // country
        $queryClause .= " AND subcat_tid=? ";
        $bindparams[]=$countrytid;
        $bindparamss.="s";
                        // groupname
        $queryClause .= " AND groupname=? ";
        ...
        $sqlQuery = "SELECT image,name,average_cashback_percent,product_trackid,type FROM bill_top_up_main_products  WHERE status=?  $queryClause";
