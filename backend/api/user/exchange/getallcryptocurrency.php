...
if ($method == 'GET') {
    ...
    // $user_pubkey = cleanme($decodedToken->usertoken);
        ...
        $sqlQuery = "SELECT producttrackid,stablecoin,name,priceapidetails,priceapiname,rate,colorcode,img,wheretoshow,maxcoingenerate,coingentype,shortname FROM coinproducts WHERE status=? AND showin_exchange=? $typeClause $searchclause";
