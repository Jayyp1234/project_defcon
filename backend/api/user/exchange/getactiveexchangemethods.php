...
if ($method == 'GET') {
    ...
    //         $userid = getUserWithPubKey($connect, $user_pubkey);
        ...
        $sqlQuery = "SELECT name,trackid,exchangesystem,img,shortname  FROM exchangecurrency WHERE status=? $searchclause";
        ...
        if($numRow > 0){
            ...
            while($users = $result->fetch_assoc()){
                $users['joincode']=$users['trackid']."|".$users['exchangesystem'];
