...
if ($method == 'POST') {
        ...
        }else if (empty( $cryptotrackid) || empty($currency) ||empty($addressname)) {//checking if data is empty
            $errordesc="Bad request";
            $linktosolve="https://";
                                          ...
                                          if($generateadd!=false){
                                                ...
                                                if($numRow > 0){
                                                        while($users = $result->fetch_assoc()){
                                                                ...
                                                                array_push( $allrespnse,array("name"=>$addressname,"address"=>$addressis,"currency"=>$currencyname,"cointoshow"=>$coinname));
                                                        }
                                                }
