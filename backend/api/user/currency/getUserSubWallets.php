...
if ($method == 'GET') {
    ...
    $user_pubkey = cleanme($decodedToken->usertoken);
        ...
        $walletbal= round($walletbal,8);
        
                                                                array_push( $allResponse,array("coinrate"=>$coinrate,"currencytag"=>$currencytagis,"currency"=>$currencyname,"coinname"=>$coinname,"usdbalance"=>$thusdval,"usdpendbalance"=>$thpendusdval,"balance"=>$walletbal,"pendbal"=>$walletpendbal,"trackid"=>$trackid));
            }
