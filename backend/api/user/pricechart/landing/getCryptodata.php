...
if (getenv('REQUEST_METHOD') === 'POST'){
        ...
        $url ="https://min-api.cryptocompare.com/data/pricemultifull?fsyms=$cryptotag&tsyms=$currency&api_key=$key&extraParams=$appid";
            $curl = curl_init();
            ...
            if ($err) {
                ...
                $maindata['userdata']=$data->{'DISPLAY'}->{$cryptotag}->{$currency};
                $errordesc = " ";
                $linktosolve = "https://";
                $hint = [];
                $errordata = [];
